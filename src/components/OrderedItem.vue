...
const product = computed(() => {
	console.log("product recompute", item.value, item.value.productId, productStore.getProductById(item.value.productId))
	return productStore.getProductById(item.value.productId)
})
