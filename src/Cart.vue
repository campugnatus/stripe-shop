	...
	<main class="mx-auto mt-10 md:mt-16 lg:mt-28 max-w-screen-lg px-4 sm:px-6 lg:px-8 md:flex">
		<div class="md:w-1/2 h-full md:pr-6 lg:pr-16 py-6">
			<div class="flex justify-between">
				...
				<button class="flex gap-2 items-center text-gray-500" title="Remove from cart">
			...
			<div class="mt-6 md:mt-10 space-y-6">
				<CartItem/>
				<CartItem/>
			</div>

			<div class="flex justify-between text-2xl md:text-3xl font-roboto mt-8 lg:mt-14">
				<div>Total</div>
				<div class="font-bold">$1.98</div>
			</div>
		</div>
