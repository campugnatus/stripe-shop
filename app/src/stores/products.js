	...
	actions: {
		...
		async fetchCollection (name) {
			const collection = await new Promise((resolve, reject) => {
				setTimeout(() => {
					if (name === 'recommended') {
						resolve(["644:2785", "644:2849",  "644:2945", "644:2857", "644:2833", "644:2801", "644:2809", "644:3057", "644:2889", "644:3129"])
					}
					else if (name === '1') {
						resolve(["617:1384", "644:2521", "644:2505", "644:2481", "644:2513", "644:2617", "644:2601", "644:2289", "644:2265", "644:2545", "644:2721", "644:2713"])
					}
					else if (name === '2') {
						resolve(["644:2577", "579:1077", "644:2593", "644:2697", "644:2705", "644:2681", "644:2753"])
					}
					else if (name === '3') {
						resolve(["644:2281", "644:2633", "644:2585", "644:2537", "644:2641", "644:2649", "644:2657", "644:2665", "644:2761"])
					}
